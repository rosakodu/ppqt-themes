...
def make_styles(inherits, bg, bg_darker, surface, surface_elevated, surface_hover, card_bg, text, text_muted, disabled_text, border, accent, accent_dark, accent_blue, grad_colors, font="Inter", r_small="8px", r_large="14px", r_card="12px", preloader_style="pulse"):
...
print("GENERATED DARK THEMES ONLY!")

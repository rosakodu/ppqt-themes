...
def make_styles(inherits, bg, bg_darker, surface, surface_elevated, surface_hover, card_bg, text, text_muted, disabled_text, border, accent, accent_dark, accent_blue, grad_colors, bg_gradient_stops, font="Inter", r_small="8px", r_large="14px", r_card="18px", r_badge="6px", preloader_style="pulse", anim_type="gradient"):
...
create_theme("nord",
    ...
    make_styles("standart", "#2e3440", "#242933", "#3b4252", "#434c5e", "#4c566a", "#3b4252", "#eceff4", "#d8dee9", "#4c566a", "#4c566a", "#88c0d0", "#5e81ac", "#81a1c1", [(0, "#88c0d0"), (0.5, "#81a1c1"), (1, "#88c0d0")], [(0, "#1b1f27"), (0.5, "#2e3440"), (1, "#3b4252")], r_card="18px", r_badge="6px")
)
...
create_theme("tokyo-night", 
    ...
    make_styles("standart", "#1a1b26", "#16161e", "#24283b", "#292e42", "#343b58", "#24283b", "#c0caf5", "#a9b1d6", "#565f89", "#3b4261", "#7aa2f7", "#3d59a1", "#7dcfff", [(0, "#7aa2f7"), (0.5, "#bb9af7"), (1, "#7aa2f7")], [(0, "#13141c"), (0.5, "#1a1b26"), (1, "#24283b")], r_card="18px", r_badge="6px")
)
...
# 11. Felix
create_theme("felix", 
    {"dark_variant": "felix", "light_variant": "felix", "name_en": "Felix", "name_ru": "Felix", "description_en": "Minimalist black & orange theme", "description_ru": "Минималистичная чёрная тема с оранжевым акцентом"},
...
print("UPDATED FELIX METAINFO DESCRIPTION TO CLEAN MINIMALIST!")
